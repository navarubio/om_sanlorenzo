var imagePath = '';
var adulto = false;
var oleary1 = {idJsonField: '.jsonOleary1', idMasterContainer: '.oleary1', idBaseContainer: 'ole1', initTooth: 523};
var oleary2 = {idJsonField: '.jsonOleary2', idMasterContainer: '.oleary2', idBaseContainer: 'ole2', initTooth: 687};
function drawTableOleary(container, data) {
    $(container).append('<table style="margin:0 auto;"><tbody>\n\
<tr><td>18</td><td>17</td><td>16</td><td>15-55</td><td>14-54</td><td>13-53</td><td>12-52</td><td>11-51</td><td>21-61</td><td>22-62</td><td>23-63</td><td>24-64</td><td>25-65</td><td>26</td><td>27</td><td>28</td></tr>\n\
<tr><td>48</td><td>47</td><td>46</td><td>45-85</td><td>44-84</td><td>43-83</td><td>42-82</td><td>41-81</td><td>31-71</td><td>32-72</td><td>33-73</td><td>34-74</td><td>35-75</td><td>36</td><td>37</td><td>38</td></tr>\n\
<tbody></table>');
    $.each($(container).find('table:last tbody tr td'), function (index, td) {
        var valor = $(td).text();
        $(td).text('');
        $(td).attr('id', data.idBaseContainer + index);
        drawToothOleary($(td).get(0), valor);
    });
}
...
function drawToothOleary(container, numTooth) {
...
function onClickOleary(element) {
