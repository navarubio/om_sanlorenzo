...
update hc_campos_reg set tabla='date2' where posicion=32 and id_Tipo_reg=85;
update hc_tipo_reg set cant_campos=162,url_pagina='g_historia_clinica_planificacion_familiar.xhtml'  where id_Tipo_reg=85;
update hc_Campos_Reg set nombre='TELEFONO', nombre_pdf='TELEFONO' where posicion=2 and id_tipo_reg=5;
...
update hc_campos_reg set nombre='TSH',nombre_pdf='TSH' where posicion=176 and id_Tipo_reg=84
...
update hc_campos_reg set nombre='CITA CONTROL',nombre_pdf='CITA CONTROL' where posicion=223 and id_Tipo_reg=83
update hc_tipo_reg set url_pagina='s_historia_prevencion_enfermedades_cronicas.xhtml',cant_campos=226 where id_tipo_reg=83;
update hc_campos_reg set tabla='date2' where posicion=167 and id_Tipo_reg=84
