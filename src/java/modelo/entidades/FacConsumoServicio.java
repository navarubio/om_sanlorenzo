...
import beans.enumeradores.EstadoConsumo;
...
public class FacConsumoServicio implements Serializable {
    ...
    @JoinColumn(name = "id_urgordencobro")
    @ManyToOne
    ...
    @JoinColumn(name = "id_profesional_gestiona")
    @ManyToOne
    private CfgUsuarios profesionaApruebaServicio;
    ...
    public CfgUsuarios getProfesionaApruebaServicio() {
        return profesionaApruebaServicio;
    }

    public void setProfesionaApruebaServicio(CfgUsuarios profesionaApruebaServicio) {
        this.profesionaApruebaServicio = profesionaApruebaServicio;
    }
