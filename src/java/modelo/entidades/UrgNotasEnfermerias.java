...
@Entity
@XmlRootElement
@Table(name = "urg_notas_enfermerias", schema = "public")

public class UrgNotasEnfermerias implements Serializable {
    ...
    public UrgNotasEnfermerias() {
    }

    public UrgNotasEnfermerias(Integer idNota) {
        this.idNota = idNota;
    }

    public UrgNotasEnfermerias(Integer idNota, UrgConsultaPacienteUrgencia idUrgConsultaPacienteUrgencia, CfgUsuarios idPrestador) {
        this.idNota = idNota;
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + Objects.hashCode(this.idPrestador);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final UrgNotasEnfermerias other = (UrgNotasEnfermerias) obj;
