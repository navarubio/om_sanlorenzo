...
public class FacContrato implements Serializable {
    ...
    @OneToMany(mappedBy = "idContrato")
    private List<CfgPacientes> facPacienteList;
    @Transient
    private String vigencia;
    @Transient
    private String manualTarifa;
    ...
    public List<CfgPacientes> getFacPacienteList() {
        return facPacienteList;
    }

    public void setFacPacienteList(List<CfgPacientes> facPacienteList) {
        this.facPacienteList = facPacienteList;
    }
    ...
    public String getManualTarifa() {
        if(tipoManual!=null){
            if(null!=tipoManual)switch (tipoManual) {
                case 1:
                    manualTarifa    = "ESPECIFICO";
                    break;
                case 2:
                    manualTarifa    = "ISS "+signoPorcentaje+" "+porcentaje+"%";    
                    break;
                case 3:
                    manualTarifa    = "SOAT "+signoPorcentaje+" "+porcentaje+"%";
                    break;
                default:
                    break;
            }
    ...
    public void setManualTarifa(String manualTarifa) {
        this.manualTarifa = manualTarifa;
    }
