...
public class FacAdministradora implements Serializable {
    ...
    @OneToMany(mappedBy = "idAdministradora")
    private List<CfgCamposArchivosPaciente> cfgCamposArchivosPacienteList;
    ...
    @XmlTransient
    public List<CfgCamposArchivosPaciente> getCfgCamposArchivosPacienteList() {
        return cfgCamposArchivosPacienteList;
    }

    public void setCfgCamposArchivosPacienteList(List<CfgCamposArchivosPaciente> cfgCamposArchivosPacienteList) {
        this.cfgCamposArchivosPacienteList = cfgCamposArchivosPacienteList;
    }
