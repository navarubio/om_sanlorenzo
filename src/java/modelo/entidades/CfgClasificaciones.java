...
public class CfgClasificaciones implements Serializable {
    ...
    private Collection<Hc3047Anexo5> hc3047Anexo5Collection1;
    @OneToMany(mappedBy = "idMunicipio")
    private Collection<Hc3047Anexo5> hc3047Anexo5Collection2;
    @OneToMany(mappedBy = "tipoIdentificacion")
    private Collection<Hc3047Anexo6> hc3047Anexo6Collection;
    @OneToMany(mappedBy = "idDepartamento")
    private Collection<Hc3047Anexo6> hc3047Anexo6Collection1;
    @OneToMany(mappedBy = "idMunicipio")
    private Collection<Hc3047Anexo6> hc3047Anexo6Collection2;
    @OneToMany(mappedBy = "idservicio")
    private Collection<Hc3047Anexo4> hc3047Anexo4Collection;
    @OneToMany(mappedBy = "idservicio")
    private Collection<Hc3047Anexo3> hc3047Anexo3Collection;
    @OneToMany(mappedBy = "idorigenatencion")
    private Collection<Hc3047Anexo3> hc3047Anexo3Collection1;
    @OneToMany(mappedBy = "iddestinopaciente")
    ...
    @OneToMany(mappedBy = "tipoCita")
    private List<UrgConsultaPacienteUrgencia> urgConsultaPacienteUrgenciaList;
    ...
    @XmlTransient
    public List<UrgDetalleConsulta> getUrgDetalleConsultaList() {
        return urgDetalleConsultaList;
    }

    public void setUrgDetalleConsultaList(List<UrgDetalleConsulta> urgDetalleConsultaList) {
        this.urgDetalleConsultaList = urgDetalleConsultaList;
    }
    ...
    @XmlTransient
    public List<UrgConsultaPacienteUrgencia> getUrgConsultaPacienteUrgenciaList() {
        return urgConsultaPacienteUrgenciaList;
    }

    public void setUrgConsultaPacienteUrgenciaList(List<UrgConsultaPacienteUrgencia> urgConsultaPacienteUrgenciaList) {
        this.urgConsultaPacienteUrgenciaList = urgConsultaPacienteUrgenciaList;
    }
    ...
    @XmlTransient
    public List<UrgPlanManejoPaciente> getUrgDestinoPacienteList() {
        return urgDestinoPacienteList;
    }

    public void setUrgDestinoPacienteList(List<UrgPlanManejoPaciente> urgDestinoPacienteList) {
        this.urgDestinoPacienteList = urgDestinoPacienteList;
    }
    ...
    @XmlTransient
    public Collection<Hc3047Anexo3> getHc3047Anexo3Collection() {
        return hc3047Anexo3Collection;
    }

    public void setHc3047Anexo3Collection(Collection<Hc3047Anexo3> hc3047Anexo3Collection) {
        this.hc3047Anexo3Collection = hc3047Anexo3Collection;
    }

    @XmlTransient
    public Collection<Hc3047Anexo3> getHc3047Anexo3Collection1() {
        return hc3047Anexo3Collection1;
    }

    public void setHc3047Anexo3Collection1(Collection<Hc3047Anexo3> hc3047Anexo3Collection1) {
        this.hc3047Anexo3Collection1 = hc3047Anexo3Collection1;
    }

    @XmlTransient
    public Collection<Hc3047Anexo4> getHc3047Anexo4Collection() {
        return hc3047Anexo4Collection;
    }
    ...
    @XmlTransient
    public Collection<Hc3047Anexo5> getHc3047Anexo5Collection1() {
        return hc3047Anexo5Collection1;
    }

    public void setHc3047Anexo5Collection1(Collection<Hc3047Anexo5> hc3047Anexo5Collection1) {
        this.hc3047Anexo5Collection1 = hc3047Anexo5Collection1;
    }

    @XmlTransient
    public Collection<Hc3047Anexo5> getHc3047Anexo5Collection2() {
        return hc3047Anexo5Collection2;
    }

    public void setHc3047Anexo5Collection2(Collection<Hc3047Anexo5> hc3047Anexo5Collection2) {
        this.hc3047Anexo5Collection2 = hc3047Anexo5Collection2;
    }
    ...
    @XmlTransient
    public Collection<Hc3047Anexo6> getHc3047Anexo6Collection1() {
        return hc3047Anexo6Collection1;
    }

    public void setHc3047Anexo6Collection1(Collection<Hc3047Anexo6> hc3047Anexo6Collection1) {
        this.hc3047Anexo6Collection1 = hc3047Anexo6Collection1;
    }

    @XmlTransient
    public Collection<Hc3047Anexo6> getHc3047Anexo6Collection2() {
        return hc3047Anexo6Collection2;
    }

    public void setHc3047Anexo6Collection2(Collection<Hc3047Anexo6> hc3047Anexo6Collection2) {
        this.hc3047Anexo6Collection2 = hc3047Anexo6Collection2;
    }
