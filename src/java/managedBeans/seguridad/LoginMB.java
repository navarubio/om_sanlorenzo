...
public class LoginMB extends MetodosGenerales implements Serializable {
    ...
    private String urlFile = "";//url del directorio para archivos (historia clinica)
    ...
    private CfgPacientes cfgPacientes;
    ...
    private void realizarConfiguraciones() {
        ...
        urlFile = rutaCarpetaImagenes + getBaseDeDatosActual() + "/Archivoshistoria/";
        directorio = new File(urlFile);
        if (!directorio.exists()) {
            directorio.mkdirs();
        }
...
//                System.out.println("pacienteId->"+id);
    ...
    public CfgPacientes getCfgPacientes() {
        return cfgPacientes;
    }

    public void setCfgPacientes(CfgPacientes cfgPacientes) {
        this.cfgPacientes = cfgPacientes;
    }
