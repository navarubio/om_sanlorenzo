...
public class PaginaInformativaMB extends MetodosGenerales implements Serializable {
    ...
    private void crearGraficoFacturacion() {
        ...
        Calendar fechaHasta = fechaFin;
        fechaHasta.set(Calendar.DAY_OF_MONTH, fechaFin.getActualMaximum(Calendar.DAY_OF_MONTH) );
        List<FacFacturaPaciente> listaFacturasFaltanCobrar = facturaPacienteFacade.buscarFaltanFacturarInforme(fechaDesde.getTime(),fechaHasta.getTime());
        boolean encontrado;
        double total = 0;
