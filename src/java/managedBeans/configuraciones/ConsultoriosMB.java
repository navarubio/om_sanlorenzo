...
public class ConsultoriosMB extends MetodosGenerales implements Serializable {
    ...
    public void validarConsultorio() {
    ...
    private void guardarNuevoConsultorio() {
        ...
        int consultorio = consultoriosFacade.numeroConsultorios(codigoConsultorio);
        
        if (consultorio > 0) {

            imprimirMensaje("Informacion", "El codigo ya se encuentra registrado", FacesMessage.SEVERITY_ERROR);
            return;
